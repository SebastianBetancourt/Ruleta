...
public class Moneda extends JLabel {
	...
	public void determinarTipoApuesta() {
		...
		}else if(columnaCasilla == 13 && filaCasilla < 3 && !((filaRegion == 2 && filaCasilla != 2) || (filaRegion == 0 && filaCasilla != 0))){this.setTipoDeApuesta(Moneda.COLUMNA);
		}else if(filaCasilla == 3 && filaRegion != 0 && ((columnaRegion == 2 && (columnaCasilla == 4 || columnaCasilla == 8)) || (columnaRegion == 0 && (columnaCasilla == 5 || columnaCasilla == 9)))){this.setTipoDeApuesta(Moneda.DOSDOCENAS);
		}else if(columnaCasilla == 13 && filaCasilla < 3 && ((filaRegion == 2 && filaCasilla != 2) || (filaRegion == 0 && filaCasilla != 0))){this.setTipoDeApuesta(Moneda.DOSCOLUMNAS);
		}else if(columnaCasilla > 0 && columnaCasilla < 13 && columnaRegion != 1 && ((filaCasilla == 3 && filaRegion == 0) || (filaCasilla == 2 && filaRegion == 2)) && !(columnaCasilla == 1 && columnaRegion==0) && !(columnaCasilla == 12 && columnaRegion == 2)){this.setTipoDeApuesta(Moneda.SEISENA);
		...
		}else if((filaCasilla == 3 && filaRegion == 0 && (columnaRegion == 1 || (columnaCasilla == 1 && columnaRegion == 0) || (columnaCasilla == 12 && columnaRegion == 2))) || ((columnaCasilla == 0 && (((filaCasilla == 0 || filaCasilla == 1) && (filaRegion == 2 && columnaRegion == 2))) || ((filaCasilla == 1 || filaCasilla == 2) && (filaRegion == 0 && columnaRegion == 2)))) || ((columnaCasilla == 1 && (((filaCasilla == 0 || filaCasilla == 1) && (filaRegion == 2 && columnaRegion == 0))) || ((filaCasilla == 1 || filaCasilla == 2) && (filaRegion == 0 && columnaRegion == 0))))){this.setTipoDeApuesta(Moneda.TRANSVERSAL);
